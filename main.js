...
rnd_number = Math.floor((Math.random()*quick_draw_data_set.length)+1);
console.log(quick_draw_data_set[rnd_number]);
sketch = quick_draw_data_set[rnd_number];
document.getElementById("s_draw").innerHTML = "Sketch to be drawn: " + sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
{
    background("white");
    random_num = Math.floor(quick_draw_data_set);
    sketch = console.log(random_num);
    document.getElementById("s_draw").innerHTML = sketch;
}